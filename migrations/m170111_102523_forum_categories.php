...
class m170111_102523_forum_categories extends Migration
{
    ...
    public function up()
    {
        $this->createTable(Categories::tableName(), [
            ...
            'last_topic_id' => $this->integer(11)->notNull()->unsigned(),
            'last_post_id' => $this->integer(11)->notNull()->unsigned(),
            'last_post_user_id' => $this->integer(11)->notNull()->unsigned(),
            'count_topics' => $this->integer(11)->defaultValue(0),
            'count_posts' => $this->integer(11)->defaultValue(0),
