...
class TinyMce extends BaseTinyMce
{
    ...
    public function init()
    {
        ...
        $this->clientOptions['toolbar'] = "blockquote fontselect fontsizeselect | forecolor backcolor | styleselect | bold italic | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | link image";
        $this->clientOptions['formats']['blockquote'] = ['block'=>'blockquote','classes'=>'foo'];
